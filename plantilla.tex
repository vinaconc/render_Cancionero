...
% \usepackage[normalem]{ulem} % Eliminado para evitar dependencia no instalada
% \usepackage{scrextend} % Eliminado para evitar dependencia no instalada
...
% \changefontsizes[14pt]{11pt} % Eliminado para evitar dependencia de scrextend
...
% Redefinición visual de \diagram y \esquema (sin 'schemata')
\newcommand\diagram[2]{%
  \par\noindent
  \setlength{\fboxsep}{6pt}%
  \fcolorbox{black}{gray!10}{\textsf{\bfseries #1}}\hspace{0.6em}%
  \fcolorbox{black}{gray!5}{%
    \begin{minipage}[t]{\dimexpr\linewidth-2\fboxrule-2\fboxsep-2em\relax}
      #2
    \end{minipage}%
  }\par\vspace{0.5\baselineskip}
}
\newcommand\esquema[2]{\diagram{#1}{#2}}
\newcommand{\version}{}
