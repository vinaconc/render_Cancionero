...
\usepackage{schemata} % <-- ¡RE-AÑADIDO PARA EL COMANDO \diagram!
...
\newcommand\diagram[2]{\schema{\schemabox{#1}}{\schemabox{#2}}} % <-- ¡DEFINICIÓN DE \diagram!
\newcommand\esquema[2]{\schema[closed]{#2}{\schemabox{#1}}} % Si no usas este comando, puedes eliminarlo.
\newcommand{\version}{}
